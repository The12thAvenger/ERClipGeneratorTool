...
public partial class TAE : SoulsFile<TAE>
{
    ...
    public void ApplyTemplate(TAE.Template template)
    {
        ...
        else
        {
            throw new InvalidOperationException(
                $"This TAE uses event bank {EventBank} but no such bank exists in the template.");
        }
    ...
    /// <summary>
    /// For use with porting to other games etc. Make sure fields are named the same between games or this will throw a
    /// KeyNotFoundException (obviously).
    /// </summary>
