...
public partial class TAE
{
    ...
    public class Template : Dictionary<long, Template.BankTemplate>
    {
        ...
        public enum ParamType
        {
            ...
            /// <summary>
            /// Single-precision float gradient. Two float values to blend over time from the start of the event to the end of the
            /// event.
            /// </summary>
            f32grad,
                ...
                : base()
            {
                ...
                foreach (XmlNode eventNode in bankNode.SelectNodes("event"))
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        {
                            throw new Exception(
                                $"Event template in bank template {ID} failed to read.\n\nLast valid event ID read: {lastGoodEventTemplate.ID}\n\nMessage:\n{e}");
                        }
                    }
                }
            }
        ...
        public class ParameterTemplate
        {
            ...
            internal ParameterTemplate(long bankId, long eventId, long paramIndex, XmlNode paramNode, int offset)
            {
                ...
                {
                    throw new Exception(
                        $"Bank {bankId} -> Event {eventId} -> Parameter {(Name != null ? $"'{Name}'" : $"{paramIndex}")}\n    Failed to read 'assert' attribute of parameter.\n\n\n{ex}");
                }
                ...
                else
                {
                    ...
                    {
                        throw new Exception(
                            $"Bank {bankId} -> Event {eventId} -> Parameter {(Name != null ? $"'{Name}'" : $"{paramIndex}")} was an " +
            ...
            public System.Type GetValueObjectType()
            {
                switch (Type)
                {
                    ...
                    case ParamType.u8:
                    case ParamType.x8: return typeof(byte);
                    case ParamType.s8: return typeof(sbyte);
                    case ParamType.u16:
                    case ParamType.x16: return typeof(ushort);
                    case ParamType.s16: return typeof(short);
                    case ParamType.u32:
                    case ParamType.x32: return typeof(uint);
                    case ParamType.s32: return typeof(int);
                    case ParamType.u64:
                    case ParamType.x64: return typeof(ulong);
            ...
            public object StringToValue(string str)
            {
                ...
                List<string> GetArrayFromString(string s)
                {
                    ...
                    foreach (var l in lines)
                        result.AddRange(
                            GetArrayFromSingleLineString(l.Replace("\r", "").Replace("\n", "").Replace("\t", "")));
                    return result;
                }
                    ...
                    case ParamType.b:
                        ...
                        if (toLower == "true")
                            ...
                            throw new FormatException(
                                "Boolean value must be either 'True' or 'False', case-insensitive.");
                    default: throw new Exception($"Invalid ParamTemplate ParamType: {Type.ToString()}");
                }
            }
            ...
            internal object ReadValue(BinaryReaderEx br)
            {
                switch (Type)
                {
                    ...
                    case ParamType.u8:
                    case ParamType.x8: return br.ReadByte();
                    case ParamType.s8: return br.ReadSByte();
                    case ParamType.u16:
                    case ParamType.x16: return br.ReadUInt16();
                    case ParamType.s16: return br.ReadInt16();
                    case ParamType.u32:
                    case ParamType.x32: return br.ReadUInt32();
                    case ParamType.s32: return br.ReadInt32();
                    case ParamType.u64:
                    case ParamType.x64: return br.ReadUInt64();
            ...
            internal void WriteAssertValue(BinaryWriterEx bw)
            {
                switch (Type)
                {
                    case ParamType.aob:
                        ...
                        break;
                    case ParamType.b:
                        bw.WriteBoolean((bool)ValueToAssert);
                        break;
                    case ParamType.u8:
                    case ParamType.x8:
                        bw.WriteByte((byte)ValueToAssert);
                        break;
                    case ParamType.s8:
                        bw.WriteSByte((sbyte)ValueToAssert);
                        break;
                    case ParamType.u16:
                    case ParamType.x16:
                        bw.WriteUInt16((ushort)ValueToAssert);
                        break;
                    case ParamType.s16:
                        bw.WriteInt16((short)ValueToAssert);
                        break;
                    case ParamType.u32:
                    case ParamType.x32:
                        bw.WriteUInt32((uint)ValueToAssert);
                        break;
                    case ParamType.s32:
                        bw.WriteInt32((int)ValueToAssert);
                        break;
                    case ParamType.u64:
                    case ParamType.x64:
                        bw.WriteUInt64((ulong)ValueToAssert);
                        break;
                    case ParamType.s64:
                        bw.WriteInt64((long)ValueToAssert);
                        break;
                    case ParamType.f32:
                        bw.WriteSingle((float)ValueToAssert);
                        break;
                    case ParamType.f32grad:
                        ...
                        break;
                    case ParamType.f64:
                        bw.WriteDouble((double)ValueToAssert);
                        break;
                    default: throw new Exception($"Invalid ParamTemplate ParamType: {Type.ToString()}");
                }
            }
            ...
            internal void WriteDefaultValue(BinaryWriterEx bw)
            {
                ...
                else
                {
                    switch (Type)
                    {
                        ...
                        case ParamType.u8:
                        case ParamType.x8:
                            bw.WriteByte((byte)DefaultValue);
                            break;
                        case ParamType.s8:
                            bw.WriteSByte((sbyte)DefaultValue);
                            break;
                        case ParamType.u16:
                        case ParamType.x16:
                            bw.WriteUInt16((ushort)DefaultValue);
                            break;
                        case ParamType.s16:
                            bw.WriteInt16((short)DefaultValue);
                            break;
                        case ParamType.u32:
                        case ParamType.x32:
                            bw.WriteUInt32((uint)DefaultValue);
                            break;
                        case ParamType.s32:
                            bw.WriteInt32((int)DefaultValue);
                            break;
                        case ParamType.u64:
                        case ParamType.x64:
                            bw.WriteUInt64((ulong)DefaultValue);
                            break;
                        case ParamType.s64:
                            bw.WriteInt64((long)DefaultValue);
                            break;
                        case ParamType.f32:
                            bw.WriteSingle((float)DefaultValue);
                            break;
                        case ParamType.f32grad:
                            ...
                            break;
                        case ParamType.f64:
                            bw.WriteDouble((double)DefaultValue);
                            break;
                        default: throw new Exception($"Invalid ParamTemplate ParamType: {Type.ToString()}");
                    }
                }
