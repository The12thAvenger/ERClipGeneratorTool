...
public partial class TAE : SoulsFile<ERClipGeneratorTool.Models.TAE.TAE>
{
    ...
    public class Event
    {
        ...
        public Event(float startTime, float endTime, int type, int unk04, bool isBigEndian,
            TAE.Template.EventTemplate template)
        {
            StartTime = startTime;
            EndTime = endTime;
            Type = type;
        ...
        /// </summary>
        public ERClipGeneratorTool.Models.TAE.TAE.EventGroup Group { get; set; }
        ...
        /// </summary>
        internal void ApplyTemplate(ERClipGeneratorTool.Models.TAE.TAE containingTae,
        ...
        internal void ChangeTemplateAfterLoading(ERClipGeneratorTool.Models.TAE.TAE containingTae,
            TAE.Template template,
            long animID, int eventIndex, int eventType)
        {
            if (template[containingTae.EventBank].ContainsKey(eventType))
        ...
        /// Applies a template to allow editing of the parameters.
        /// </summary>
        public void ApplyTemplate(bool isBigEndian, TAE.Template.EventTemplate template,
            bool lenientOnAssert = false)
        {
            if (template.ID != Type)
            {
        ...
        /// </summary>
        public void ApplyTemplateWithDefaultValues(bool isBigEndian,
            TAE.Template.EventTemplate template)
        {
            Type = template.ID;
        ...
        public class ParameterContainer
        {
            ...
            internal ParameterContainer(long animID, int eventIndex,
                bool bigEndian, byte[] paramData, TAE.Template.EventTemplate template,
            ...
            internal ParameterContainer(bool bigEndian, byte[] paramData,
                TAE.Template.EventTemplate template,
                bool suppressAssert = false)
            {
                parameterValues = new Dictionary<string, object>();
